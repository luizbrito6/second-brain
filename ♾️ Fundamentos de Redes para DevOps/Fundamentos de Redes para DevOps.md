...
- Seção 3: Camada de Rede
	- Certo vamos entender que passamos por todos os procedimentos na camada de aplicação e também temos uma conexão estabelecida na camada de transporte, agora na camada de rede que vamos realmenter ver 
